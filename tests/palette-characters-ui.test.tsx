...
import { newBlock, type Character } from "../features/shared/types";
...
function fakeClient() {
  ...
  const character: Character & { id: number; created_at: string } = {
    id: 3,
...
describe("palette and character library views", () => {
  ...
  it("keeps the original character card/table flow and saves edited character data", async () => {
    ...
    expect(screen.getByAltText("sample_character")).toBeInTheDocument();
