...
- ‘이미지 생성’ 권한이 있는 MCP 연결은 비용이 유한하게 확인되고 검증 오류가 없으며 계획당 이미지·Anlas 한도 안에 든 새 계획을 자동 승인할 수 있습니다. 준비만으로 생성이 시작되지는 않지만, MCP 도구는 승인 응답을 받은 계획을 바로 시작할 수 있습니다. 아직 승인되지 않은 계획은 정확한 계획을 앱에서 승인해야 하며, MCP로 연결 한도를 넘길 수 없습니다.
